...
;;;
;(arg-contexts (* (*-SYM *-OPER *-SBJ ))
(arg-contexts (* (*-SYM *-OPER *-SBJ))
	      (S (NP SBAR S))
              (SBAR (S))
              (PP (head 1)))
;             (PP (head-post first not PRN IN , : $ # conect CC CC1 CD DT EX FW JJ JJR JJS -LRB- LS MD NN NNP NNPS NNS PDT POS PRP PRP$ RB RBR RBS RP -RRB- TO UH VB VBD VBG VBN VBP VBZ WDT WP WP$ WRB)))
