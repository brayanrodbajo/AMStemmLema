...
public class Training extends danbikel.parser.lang.AbstractTraining {
  ...
  private final static boolean removeDaprefijo  = false;
  private final static boolean removePerson     = true;
  private final static boolean removeNumber     = false;
  private final static boolean removeMs     = false;
  ...
  protected final static String[] daprefijoMarkers = {"DA"};
   ...
   */
    protected final static String[] ms11Markers = {"-MP"};
  protected final static String[] msMarkers = {"-MS"};
  protected final static String[] ms2Markers = {"-FS"};
    protected final static String[] ms21Markers = {"-AI"};
  protected final static String[] ms3Markers = {"-PI"};
  protected final static String[] ms4Markers = {"-SI"};
   protected final static String[] ms5Markers = {"-CS"};
   protected final static String[] ms1Markers = {"-CC1"};
