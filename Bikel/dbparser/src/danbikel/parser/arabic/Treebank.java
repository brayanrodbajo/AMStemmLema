...
public class Treebank extends danbikel.parser.lang.AbstractTreebank {
  ...
  static final Symbol COORD = Symbol.add("COORD");
  // transformed nodes
  static final Symbol baseNP = Symbol.add(NP + "B");
  static final Symbol subjectlessS = Symbol.add(S + "G");
  static final Symbol subjectAugmentation = Symbol.add("-SYM");
  static final Symbol subjectAugmentation1 = Symbol.add("-OPR");
  // other basic nodes
  ...
  private static String[] verbTagStrings = {"VB",  "VBZ", "VBP"};
  ...
  public Symbol subjectAugmentation1() { return subjectAugmentation1; }
  /**
  ...
  public boolean isConjunction(Symbol label) {
    return label == CC || label.toString().startsWith("COORD");
  }
